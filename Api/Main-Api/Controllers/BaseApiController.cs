    ...
    where TReadDto : IIdentifier
{
    ...
    public async ValueTask<ActionResult<IEnumerable<TReadDto>>> GetAll() => Ok(await _service.GetAllAsync());
    ...
    public async ValueTask<ActionResult<TDetailDto>> GetById(int id)
    {
